...
namespace BL
{
    public class BLImp : IBL
    {
        ...
        public GPSCoordinate Geocode(string address)
        {
            try
            {
                string url = "http://dev.virtualearth.net/REST/v1/Locations?query=" + address + "&key=xuQaWbafayipDzIFrQEW~Ipjnd9hhYNDCxbfVKm-nGg~ArAbsa9w-R_uDCNusHl1PmbMRzw6pR1QBwQMwb-_bgsXqr0_mOK09R5Sycrful0K";
        ...
        public string ReverseGeocode(double latitude, double longitude)
        {
            try
            {
                using (var client = new WebClient())
                {
                    var queryString = "http://dev.virtualearth.net/REST/v1/Locations/" + latitude.ToString() + "," + longitude.ToString() + "?key=xuQaWbafayipDzIFrQEW~Ipjnd9hhYNDCxbfVKm-nGg~ArAbsa9w-R_uDCNusHl1PmbMRzw6pR1QBwQMwb-_bgsXqr0_mOK09R5Sycrful0K";
        ...
        public GPSCoordinate GetGeoTaggingFromImage(string imagePath)
        {
            ...
            {
                reader = new ExifReader(@"C:\Users\Avihu\Source\Repos\photosToLocateMissileFallProject\images.jpg");
            }
